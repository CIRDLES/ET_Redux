/*
 * CommonLeadLossCorrectionSchemeC.java
 *
 *
 ...
 */
public class CommonLeadLossCorrectionSchemeC extends AbstractCommonLeadLossCorrectionScheme {

    // Class variables
    private static final long serialVersionUID = 3654927198712423996L;
    private static CommonLeadLossCorrectionSchemeC instance = null;

    private CommonLeadLossCorrectionSchemeC() {
        super("C", false);
    }
     ...
     * @return
     */
    public static CommonLeadLossCorrectionSchemeC getInstance() {
        if (instance == null) {
            instance = new CommonLeadLossCorrectionSchemeC();
        }
        return instance;
    }
