/*
 * CommonLeadLossCorrectionSchemeNONE.java
 *
 *
 ...
 */
public class CommonLeadLossCorrectionSchemeNONE extends AbstractCommonLeadLossCorrectionScheme {

    // Class variables
    private static final long serialVersionUID = -898481500928425738L;
    private static CommonLeadLossCorrectionSchemeNONE instance = null;

    private CommonLeadLossCorrectionSchemeNONE() {
        super("NONE", false);
    }
     ...
     * @return
     */
    public static CommonLeadLossCorrectionSchemeNONE getInstance() {
        if (instance == null) {
            instance = new CommonLeadLossCorrectionSchemeNONE();
        }
        return instance;
    }
