 ...
 * @author CIRDLES.org
 */
public interface UseriesIsochronPlotDisplayInterface {

    /**
     *
     * @return
     */
    Map<String, String> getUSeriesIsochronOptions();

    public void setUSeriesIsochronOptions(Map<String, String> concordiaOptions);
