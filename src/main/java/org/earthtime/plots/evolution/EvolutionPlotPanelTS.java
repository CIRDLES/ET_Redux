 ...
 */
public final class EvolutionPlotPanelTS extends JLayeredPane implements AliquotDetailsDisplayInterface, ConcordiaPlotDisplayInterface, PlottingDetailsDisplayInterface {
    ...
    public EvolutionPlotPanelTS(SampleInterface mySample, ReportUpdaterInterface reportUpdater) {
        super();
