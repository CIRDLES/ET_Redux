 ...
 */
public final class MemUnivNewfoundlandElementIISetupUPb extends AbstractMassSpecSetup {
    
    private static MemUnivNewfoundlandElementIISetupUPb instance = new MemUnivNewfoundlandElementIISetupUPb();
