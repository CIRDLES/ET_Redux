 ...
 */
public final class LaserchronElementIISetupUPb_B extends AbstractMassSpecSetup {

    private static LaserchronElementIISetupUPb_B instance = new LaserchronElementIISetupUPb_B();

    private LaserchronElementIISetupUPb_B() {
        super();
        NAME = "Laserchron Element II Setup B";
...
// Noah says times 4 each
     ...
     * @return
     */
    public static LaserchronElementIISetupUPb_B getInstance() {
        return instance;
    }
    ...
    public SortedSet<DataModelInterface> rawRatiosFactoryRevised() {
        ...
        getVirtualCollectorModelMapToFieldIndexes().put(U235, 6);
        getVirtualCollectorModelMapToFieldIndexes().put(U238, 7);
