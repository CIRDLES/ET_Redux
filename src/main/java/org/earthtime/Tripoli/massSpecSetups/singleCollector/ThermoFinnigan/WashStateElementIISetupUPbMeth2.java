/*
 * WashStateElementIISetupUPbMeth2
 *
 ...
 */
public final class WashStateElementIISetupUPbMeth2 extends AbstractMassSpecSetup {

    private static WashStateElementIISetupUPbMeth2 instance = new WashStateElementIISetupUPbMeth2();

    private WashStateElementIISetupUPbMeth2() {
        super();
        NAME = "Washington State Element II Method 2";
        ...
        isotopeMappingModel.getIsotopeToIntegrationTimeMap().put( //
                IsotopesEnum.Pb207, 0.024);

        isotopeMappingModel.getIsotopeToCollectorMap().put(//
                IsotopesEnum.Pb206, singleCollector);
        isotopeMappingModel.getIsotopeToIntegrationTimeMap().put( //
                IsotopesEnum.Pb206, 0.024);
     ...
     * @return
     */
    public static WashStateElementIISetupUPbMeth2 getInstance() {
        return instance;
    }
