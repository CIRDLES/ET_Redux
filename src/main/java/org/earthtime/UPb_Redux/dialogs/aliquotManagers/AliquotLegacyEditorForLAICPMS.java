/*
 * AliquotLegacyEditorForLAICPMS.java
 *
 *
 ...
 */
public class AliquotLegacyEditorForLAICPMS extends AliquotEditorDialog {
...
//        tempJB.addActionListener( new editFractionListener( tempFrac, row ) );
     ...
     * @param row
     */
    protected void updateFractionRow ( Fraction tempFrac, int row ) {
...
//        sample.setSampleIGSN( sampleIGSN_text.getText().trim() );
     ...
     */
    protected void saveAliquotFraction ( Fraction tempFrac )
            throws NumberFormatException {
