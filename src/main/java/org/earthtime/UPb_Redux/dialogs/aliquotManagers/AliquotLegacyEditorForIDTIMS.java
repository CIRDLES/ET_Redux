...
public class AliquotLegacyEditorForIDTIMS extends AliquotEditorDialog {
    ...
    public void initAliquot() {
        ...
        fractionR206_204tfc_Text = new ArrayList<>();
        fractionR208_206r_Text = new ArrayList<>();

        // composition
        fractionRadToCommonTotal_Text = new ArrayList<>();

        fractionTotRadiogenicPbMass_Text = new ArrayList<>();
        fractionTotRadiogenicPbMassPICOGRAMS = new ArrayList<>();

        fractionTotCommonPbMass_Text = new ArrayList<>();
        fractionTotCommonPbMassPICOGRAMS = new ArrayList<>();

        fractionConcU_Text = new ArrayList<>();
        fractionConcUPPM = new ArrayList<>();

        fractionConcPb_ib_Text = new ArrayList<>();
        fractionConcPb_ibPPM = new ArrayList<>();

        fractionRTh_Usample_Text = new ArrayList<>();

        fractionMass_Text = new ArrayList<>();
        ...
        fractionDate206_238r_Th_Text = new ArrayList<>();
        fractionDate206_238r_Th2SigmaAbs_Text = new ArrayList<>();

        fractionDate207_235r_Pa_Text = new ArrayList<>();
        fractionDate207_235r_Pa2SigmaAbs_Text = new ArrayList<>();

        fractionDate207_206r_Th_Text = new ArrayList<>();
        fractionDate207_206r_Th2SigmaAbs_Text = new ArrayList<>();

        fractionDate207_206r_Pa_Text = new ArrayList<>();
        fractionDate207_206r_Pa2SigmaAbs_Text = new ArrayList<>();
    ...
    private void updateFractionRow(ETFractionInterface tempFrac, int row) {
        ...
        ((JTextComponent) fractionR206_238r2SigmaPct_Text.get(row)).setText(tempFrac.getRadiogenicIsotopeRatioByName("r206_238r").getTwoSigmaPct().
        ...
        ((JTextComponent) fractionR207_235r_Text.get(row)).setText(tempFrac.getRadiogenicIsotopeRatioByName("r207_235r").getValue().
                setScale(ReduxConstants.DEFAULT_DEFAULTS_SCALE,
                        RoundingMode.HALF_UP).toPlainString());
        ((JTextComponent) fractionR207_235r2SigmaPct_Text.get(row)).setText(tempFrac.getRadiogenicIsotopeRatioByName("r207_235r").getTwoSigmaPct().
                setScale(ReduxConstants.DEFAULT_PARAMETERS_SCALE,
                        RoundingMode.HALF_UP).toPlainString());
        ...
        ((JTextComponent) fractionR207_206r_Text.get(row)).setText(tempFrac.getRadiogenicIsotopeRatioByName("r207_206r").getValue().
                setScale(ReduxConstants.DEFAULT_DEFAULTS_SCALE,
                        RoundingMode.HALF_UP).toPlainString());
        ((JTextComponent) fractionR207_206r2SigmaPct_Text.get(row)).setText(tempFrac.getRadiogenicIsotopeRatioByName("r207_206r").getTwoSigmaPct().
                setScale(ReduxConstants.DEFAULT_PARAMETERS_SCALE,
                        RoundingMode.HALF_UP).toPlainString());
        ...
        ((JTextComponent) fractionR206_204tfc_Text.get(row)).setText(tempFrac.getSampleIsochronRatiosByName("r206_204tfc").getValue().
                setScale(ReduxConstants.DEFAULT_DEFAULTS_SCALE,
                        RoundingMode.HALF_UP).toPlainString());

        ((JTextComponent) fractionR208_206r_Text.get(row)).setText(tempFrac.getRadiogenicIsotopeRatioByName("r208_206r").getValue().
                setScale(ReduxConstants.DEFAULT_DEFAULTS_SCALE,
                        RoundingMode.HALF_UP).toPlainString());

        // Composition
        ((JTextComponent) fractionRadToCommonTotal_Text.get(row)).setText(tempFrac.getCompositionalMeasureByName("radToCommonTotal").getValue().
                setScale(ReduxConstants.DEFAULT_DEFAULTS_SCALE,
                        RoundingMode.HALF_UP).toPlainString());

        ((JTextComponent) fractionTotRadiogenicPbMass_Text.get(row)).setText(tempFrac.getCompositionalMeasureByName("totRadiogenicPbMass").getValue().multiply(ReduxConstants.PicoGramsPerGram).setScale(ReduxConstants.DEFAULT_PARAMETERS_SCALE,
                RoundingMode.HALF_UP).toPlainString());

        ((JTextComponent) fractionTotCommonPbMass_Text.get(row)).setText(tempFrac.getCompositionalMeasureByName("totCommonPbMass").getValue().multiply(ReduxConstants.PicoGramsPerGram).setScale(ReduxConstants.DEFAULT_PARAMETERS_SCALE,
                RoundingMode.HALF_UP).toPlainString());
        ...
        ((JTextComponent) fractionMass_Text.get(row)).setText(tempFrac.getAnalysisMeasure(AnalysisMeasures.fractionMass.getName()).getValue().
                setScale(ReduxConstants.DEFAULT_DEFAULTS_SCALE,
                        RoundingMode.HALF_UP).toPlainString());
...
//        modifyComponentKeyMapForTable(fractionR238_206r2SigmaPct_Text.get(row - 1), fractionR238_206r2SigmaPct_Text, row + 1);
    ...
    private void saveAliquot() {
        ...
        mineralStandardsCheckBoxes.stream().filter((cb) -> (((AbstractButton) cb).isSelected())).forEach((cb) -> {
            try {
        ...
        for (ETFractionInterface addedFraction : addedFractions) {
            getSample().addFraction((UPbFraction) addedFraction);
            getMyAliquot().getAliquotFractions().add(addedFraction);
        }
    ...
    private void saveAliquotFraction(ETFractionInterface tempFrac)
        ...
        oneSigmaPct = new BigDecimal(((JTextComponent) fractionR207_235r2SigmaPct_Text.get(row)).getText()).//
        ...
        tempFrac.getSampleIsochronRatiosByName("r206_204tfc")//
                .setValue(new BigDecimal(((JTextComponent) fractionR206_204tfc_Text.get(row)).getText(), ReduxConstants.mathContext15));

        tempFrac.getRadiogenicIsotopeRatioByName("r208_206r")//
                .setValue(new BigDecimal(((JTextComponent) fractionR208_206r_Text.get(row)).getText(), ReduxConstants.mathContext15));

        // Composition
        tempFrac.getCompositionalMeasureByName("radToCommonTotal").//
                setValue(new BigDecimal(((JTextComponent) fractionRadToCommonTotal_Text.get(row)).getText(), ReduxConstants.mathContext15));

        tempFrac.getCompositionalMeasureByName("totRadiogenicPbMass")//
                .setValue(new BigDecimal(((JTextComponent) fractionTotRadiogenicPbMass_Text.get(row)).getText(), ReduxConstants.mathContext15).//
                        movePointLeft(12));

        tempFrac.getCompositionalMeasureByName("totCommonPbMass")//
                .setValue(new BigDecimal(((JTextComponent) fractionTotCommonPbMass_Text.get(row)).getText(), ReduxConstants.mathContext15).//
                        movePointLeft(12));
        ...
        tempFrac.getCompositionalMeasureByName("concPb_ib")//
                .setValue(new BigDecimal(((JTextComponent) fractionConcPb_ib_Text.get(row)).getText(), ReduxConstants.mathContext15).//
                        movePointLeft(6));
        ...
        tempFrac.getAnalysisMeasure(AnalysisMeasures.fractionMass.getName())//
                .setValue(new BigDecimal(((JTextComponent) fractionMass_Text.get(row)).getText(), ReduxConstants.mathContext15));
        ...
        tempFrac.getRadiogenicIsotopeDateByName(RadDates.age206_238r_Th)//
                .setValue(new BigDecimal(((JTextComponent) fractionDate206_238r_Th_Text.get(row)).getText(), ReduxConstants.mathContext15).//
                        movePointRight(6));
        tempFrac.getRadiogenicIsotopeDateByName(RadDates.age206_238r_Th)//
                .setOneSigma(new BigDecimal(((JTextComponent) fractionDate206_238r_Th2SigmaAbs_Text.get(row)).getText(), ReduxConstants.mathContext15).//
                        divide(new BigDecimal(2.0, ReduxConstants.mathContext15)).movePointRight(6));

        tempFrac.getRadiogenicIsotopeDateByName(RadDates.age207_235r_Pa)//
                .setValue(new BigDecimal(((JTextComponent) fractionDate207_235r_Pa_Text.get(row)).getText(), ReduxConstants.mathContext15).//
                        movePointRight(6));
        tempFrac.getRadiogenicIsotopeDateByName(RadDates.age207_235r_Pa)//
                .setOneSigma(new BigDecimal(((JTextComponent) fractionDate207_235r_Pa2SigmaAbs_Text.get(row)).getText(), ReduxConstants.mathContext15).//
                        divide(new BigDecimal(2.0, ReduxConstants.mathContext15)).movePointRight(6));

        tempFrac.getRadiogenicIsotopeDateByName(RadDates.age207_206r_Th)//
                .setValue(new BigDecimal(((JTextComponent) fractionDate207_206r_Th_Text.get(row)).getText(), ReduxConstants.mathContext15).//
                        movePointRight(6));
        tempFrac.getRadiogenicIsotopeDateByName(RadDates.age207_206r_Th)//
                .setOneSigma(new BigDecimal(((JTextComponent) fractionDate207_206r_Th2SigmaAbs_Text.get(row)).getText(), ReduxConstants.mathContext15).//
                        divide(new BigDecimal(2.0, ReduxConstants.mathContext15)).movePointRight(6));

        tempFrac.getRadiogenicIsotopeDateByName(RadDates.age207_206r_Pa.getName())//
                .setValue(new BigDecimal(((JTextComponent) fractionDate207_206r_Pa_Text.get(row)).getText(), ReduxConstants.mathContext15).//
                        movePointRight(6));
        tempFrac.getRadiogenicIsotopeDateByName(RadDates.age207_206r_Pa.getName())//
                .setOneSigma(new BigDecimal(((JTextComponent) fractionDate207_206r_Pa2SigmaAbs_Text.get(row)).getText(), ReduxConstants.mathContext15).//
                        divide(new BigDecimal(2.0, ReduxConstants.mathContext15)).movePointRight(6));
