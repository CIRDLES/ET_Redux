 ...
 * (archives). Replaced with TracerUPbModel.
 *
...
public class Tracer implements
    ...
    // Instance variables
    /**
     * name of this <code>Tracer</code>
     */
    private String tracerName;
    /**
     * version number of this <code>Tracer</code>
     */
    private int versionNumber;
    /**
     * type of this <code>Tracer</code>
     */
    private String tracerType;
    /**
     * lab name for this <code>Tracer</code>
     */
    private String labName;
    /**
     * date that this <code>Tracer</code> was certified
     */
    private String dateCertified;
    /**
     * collection of ratios for this <code>Tracer</code>
     */
    private ValueModel[] ratios;
    /**
     * collection of isotope concentrations for this <code>Tracer</code>
     */
    ...
    /**
     * creates a new instance of Tracer with its <code>tracerName</code> set to
     * argument <code>tracerName</code> and all other fields initialized to
     * default values.
     *
     * @param tracerName value to set this new <code>Tracer</code>'s
    ...
    /**
     * compares this <code>Tracer</code> to argument <code>tracer</code> by
     * their <code>name</code> and <code>version</code>.
     *
     * @pre argument <code>tracer</code> is a valid <code>Tracer</code> @post
     * returns an <code>int</code> representing the comparison between this
     * <code>Tracer</code> and argument <code>tracer</code>
     *
     * @param tracer <code>Tracer</code> to compare this <code>Tracer</code> to
     * @return <code>int</code> - 0 if this <code>Tracer</code>'s
     * <code>name</code> and <code>version</code> is the same as argument
     * <code>tracer</code>'s, -1 if they are lexicographically less than
     * argument <code>tracer</code>'s, and 1 if they are greater than argument
     * <code>tracer</code>'s
     ...
     *
     * @pre argument <code>tracer</code> is a valid <code>Tracer</code> @post
     * returns a <code>boolean</code> representing the equality of this
     * <code>Tracer</code> and argument <code>tracer</code> based on their
     * <code>name</code> and <code>version</code>
     *
     * @param tracer <code>Tracer</code> to compare this <code>Tracer</code> to
     * @return <code>boolean</code> - <code>true</code> if argument      <code>
     *          tracer</code> is this <code>Tracer</code> or their <code>name</code> and
    ...
    /**
     * returns 0 as the hashcode for this <code>Tracer</code>. Implemented to
     * meet equivalency requirements as documented by
     * <code>java.lang.Object</code>
     *
     * @pre this <code>Tracer</code> exists @post hashcode of 0 is returned for
     * this <code>Tracer</code>
     *
    ...
    /**
     * gets the <code>tracerName</code> of this <code>Tracer</code>.
     *
     * @pre this <code>Tracer</code> exists @post returns this
     * <code>Tracer</code>'s <code>tracerName</code>
     *
     * @return <code>String</code> - this <code>Tracer</code>'s
    ...
    /**
     * gets the <code>versionNumber</code> of this <code>Tracer</code>.
     *
     * @pre this <code>Tracer</code> exists @post returns this
     * <code>Tracer</code>'s <code>versionNumber</code>
     *
     * @return <code>int</code> - this <code>Tracer</code>'s
    ...
    /**
     * gets the <code>labName</code> of this <code>Tracer</code>.
     *
     * @pre this <code>Tracer</code> exists @post returns this
     * <code>Tracer</code>'s <code>labName</code>
     *
     * @return <code>String</code> - this <code>Tracer</code>'s
     * <code>labName</code>
     */
    ...
    /**
     * gets the <code>dateCertified</code> of this <code>Tracer</code>.
     *
     * @pre this <code>Tracer</code> exists @post returns this
     * <code>Tracer</code>'s <code>dateCertified</code>
     *
     * @return <code>String</code> - this <code>Tracer</code>'s
    ...
    /**
     * sets this <code>Tracer</code>'s <code>tracerName</code> to argument
     * <code>tracerName</code>.
     *
     * @pre argument <code>tracerName</code> is a valid <code>String</code>
     * @post this <code>Tracer</code>'s <code>tracerName</code> is set to
     * argument <code>tracerName</code>
     *
     * @param tracerName value to set this <code>Tracer</code>'s
     * <code>tracerName</code> to
     */
    @Override
    ...
    /**
     * sets this <code>Tracer</code>'s versionNumber</code> to argument
     * <code>versionNumber</code>.
     *
     * @pre argument <code>versionNumber</code> is a valid <code>int</code>
     * @post this <code>Tracer</code>'s <code>versionNumber</code> is set to
     * argument <code>versionNumber</code>
     *
     * @param versionNumber value to set this <code>Tracer</code>'s
    ...
    /**
     * sets this <code>Tracer</code>'s <code>labName</code> to argument
     * <code>labName</code>.
     *
     * @pre argument <code>labName</code> is a valid <code>String</code> @post
     * this <code>Tracer</code>'s <code>labName</code> is set to argument
     * <code>labName</code>
     *
     * @param labName value to set this <code>Tracer</code>'s
    ...
    /**
     * sets this <code>Tracer</code>'s <code>dateCertified</code> to argument
     * <code>dateCertified</code>.
     *
     * @pre argument <code>dateCertified</code> is a valid <code>String</code>
     * @post this <code>Tracer</code>'s <code>dateCertified</code> is set to
     * argument <code>dateCertified</code>
     *
     * @param dateCertified value to set this <code>Tracer</code>'s
    ...
    /**
     * gets the <code>tracerType</code> of this <code>Tracer</code>.
     *
     * @pre this <code>Tracer</code> exists @post returns the this
     * <code>Tracer</code>'s <code>tracerType</code>
     *
     * @return <code>String</code> - this <code>Tracer</code>'s
    ...
    /**
     * sets this <code>Tracer</code>'s <code>tracerType</code> to argument
     * <code>tracerType</code>.
     *
     * @pre argument <code>tracerType</code> is a valid <code>String</code>
     * @post this <code>Tracer</code>'s <code>tracerType</code> is set to
     * argument <code>tracerType</code>
     *
     * @param tracerType value to set this <code>Tracer</code>'s
    ...
    /**
     * gets a <code>String</code> containing this <code>Tracer</code>'s
     * <code>tracerName</code> and <code>versionNumber</code>.
     *
     * @pre this <code>Tracer</code> exists @post returns a <code>String</code>
     * containing this <code>Tracer</code>'s <code>tracerName</code> and
     * <code>versionNumber</code>
     *
     * @return <code>String</code> - this <code>Tracer</code>'s
     * <code>tracerName</code> and <code>versionNumber</code>
    ...
    /**
     * gets the <code>ratios</code> of this <code>Tracer</code>.
     *
     * @pre this <code>Tracer</code> exists @post returns this
     * <code>Tracer</code>'s <code>ratios</code>
     *
    ...
    /**
     * sets this <code>Tracer</code>'s <code>ratios</code> to argument
     * <code>ratios</code>.
     *
     * @pre argument <code>ratios</code> is a valid collection of
     * <code>ValueModel</code> @post this <code>Tracer</code>'s
     * <code>ratios</code> is set to argument <code>ratios</code>
     *
     * @param ratios collection of values to set this <code>Tracer</code>'s
     * <code>ratios</code> to
     */
    @Override
    ...
    /**
     * gets the <code>isotopeConcentrations</code> of this <code>Tracer</code>.
     *
     * @pre this <code>Tracer</code> exists @post returns this
     * <code>Tracer</code>'s <code>isotopeConcentrations</code>
     *
     * @return <code>ValueModel[]</code> - collection of this
     * <code>Tracer</code>'s <code>isotopeConcentrations</code>
     */
    ...
    /**
     * sets this <code>Tracer</code>'s <code>isotopeConcentrations</code> to
     * argument <code>isotopeConcentrations</code>.
     *
     * @pre argument <code>isotopeConcentrations</code> is a valid collection of
     * <code>ValueModel</code> @post this <code>Tracer</code>'s
    ...
    /**
     * gets the <code>tracerName</code> and <code>versionNumber</code> of this
     ...
     * <code>versionNumber</code>
     *
     * @return <code>String</code> - this <code>Tracer</code>'s      <code>
     *          tracerName</code> and <code>versionNumber</code>
     */
    @Override
    ...
    /**
     * gets a single ratio from this <code>Tracer</code>'s <code>ratios</code>
     * specified by argument <code>ratioName</code>. Returns a new, empty      <code>
     * ValueModel</code> if no matching ratio is found.
     *
     * @pre argument <code>ratioName</code> is a valid <code>String</code> @post
     * returns the <code>ValueModel</code> found in this <code>Tracer</code>'s
     * <code>ratios</code> whose name matches argument <code>ratioName</code>
     *
     * @param ratioName name of the ratio to search for
     * @return <code>ValueModel</code> - ratio found in <code>ratios</code>
     * whose name matches argument <code>ratioName</code> or a new      <code>
    ...
    /**
     * gets the isotope concentration found in this <code>Tracer</code>'s
     * <code>isotopeConcentrations</code> whose name matches argument
     * <code>isotopeConc</code>. Returns a new, empty <code>ValueModel</code> if
     * no match is found.
     *
     * @pre argument isotopeConc is a valid <code>String</code> @post returns
     * the <code>ValueModel</code> found in      <code>
     ...
     * @return <code>ValueModel</code> - isotope concentration found in
     * <code>isotopeConcentrations</code> whose name matches argument
     * <code>isotopeConc</code> or a new <code>ValueModel</code> if no match is
     * found
     */
    @Override
    ...
    /**
     * encodes this <code>Tracer</code> to the <code>file</code> specified by
     * the argument <code>filename</code>
     *
     * @pre this <code>Tracer</code> exists @post this <code>Tracer</code> is
...
//            e.printStackTrace();
    ...
    /**
     * decodes <code>Tracer</code> from <code>file</code> specified by argument
     * <code>filename</code>
     *
     * @param filename location to read data from
     * @param doValidate the value of doValidate
     * @return <code>Object</code> - the <code>Tracer</code> created from the
     ...
     * <code>Tracer</code> stored in <code>filename</code> is returned
     */
    @Override
    public Object readXMLObject(String filename, boolean doValidate)
        ...
        if (reader != null) {
            ...
            xstream.allowTypesByWildcard(new String[]{
                "org.earthtime.UPb_Redux.tracers.**",
            });
