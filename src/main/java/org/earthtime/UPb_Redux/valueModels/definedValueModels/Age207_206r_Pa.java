 ...
 */
public class Age207_206r_Pa extends ValueModel implements
        Comparable<ValueModel>,
        Serializable {

    // Class variables
    private static final long serialVersionUID = -5251571541537237216L;
    private final static String NAME = RadDates.age207_206r_Pa.getName();
    private final static String UNCT_TYPE = "ABS";
    // Instance variables
    private ValueModel r238_235s;
    private ValueModel r207_206r_Pa;
    private ValueModel age207_206r;
    private ValueModel lambda235;
    private ValueModel lambda238;

    /** Creates a new instance of Age207_206r_Pa */
    public Age207_206r_Pa () {
    ...
    public void calculateValue (
        ...
        r207_206r_Pa = inputValueModels[1];
        ...
        for (int i = 0; i < 100; i ++) {
            ...
            double new10 =
                    r207_206r_Pa.getValue().negate().doubleValue()//
        ...
        BigDecimal denominator = //
                ...
                multiply( r207_206r_Pa.getValue() ).//
        ...
        try {
            BigDecimal dAge207_206r_Pa__dR207_206r_Pa = r238_235s.getValue().//
                    multiply( BDexpLambda238xnMinus1 ).//
                    divide(denominator, ReduxConstants.mathContext15 );
            parDerivTerms.put( "dAge207_206r_Pa__dR207_206r_Pa", dAge207_206r_Pa__dR207_206r_Pa );
        } catch (Exception e) {
            parDerivTerms.put( "dAge207_206r_Pa__dR207_206r_Pa", BigDecimal.ZERO );
        }

        try {
            BigDecimal dAge207_206r_Pa__dLambda235 =getValue().//
                    multiply( BigDecimal.ONE.//
                    add( BDexpLambda235xnMinus1 ) ).//
                    divide(denominator, ReduxConstants.mathContext15 ).//
                    negate();// negate added July 2012 by Noah
            parDerivTerms.put( "dAge207_206r_Pa__dLambda235", dAge207_206r_Pa__dLambda235 );
        } catch (Exception e) {
            parDerivTerms.put( "dAge207_206r_Pa__dLambda235", BigDecimal.ZERO );
        }

        try {
            BigDecimal dAge207_206r_Pa__dLambda238 = r238_235s.getValue().//
                    multiply( r207_206r_Pa.getValue() ).//
                    multiply( getValue() ).//
                    multiply( BigDecimal.ONE.//
                    add( BDexpLambda238xnMinus1 ) ).//
                    divide(denominator, ReduxConstants.mathContext15 );
            parDerivTerms.put( "dAge207_206r_Pa__dLambda238", dAge207_206r_Pa__dLambda238 );
        } catch (Exception e) {
            parDerivTerms.put( "dAge207_206r_Pa__dLambda238", BigDecimal.ZERO );
        }

        try {
            BigDecimal dAge207_206r_Pa__dR238_235s = r207_206r_Pa.getValue().//
                    multiply( BDexpLambda238xnMinus1 ).//
                    divide(denominator, ReduxConstants.mathContext15 );
            parDerivTerms.put( "dAge207_206r_Pa__dR238_235s", dAge207_206r_Pa__dR238_235s );
        } catch (Exception e) {
            parDerivTerms.put( "dAge207_206r_Pa__dR238_235s", BigDecimal.ZERO );
        }
    }
