 ...
 */
public class ConcPb_r extends ValueModel implements
        Comparable<ValueModel>,
        Serializable {

    // Class variables
    private static final long serialVersionUID = 3522775126913270587L;
    private final static String NAME = "concPb_r";
    private final static String UNCT_TYPE = "ABS";
    // Instance variables
    private ValueModel totRadiogenicPbMass;
    private ValueModel fractionMass;

    /** Creates a new instance of ConcPb_r */
    public ConcPb_r () {
