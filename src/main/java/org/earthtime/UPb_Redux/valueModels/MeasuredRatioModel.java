 ...
 * whether or not it has been oxide-corrected. Each flag is <code>true</code>
 * if the correction occurred on a datum-by-datum basis before the means were
...
public class MeasuredRatioModel extends ValueModel implements
    ...
    /**
     * indicates whether or not the ratio has been oxide-corrected; should be set
     * to <code>true</code> when data has been oxide-corrected on a per-datum basis.
     */
     ...
     * @param   fracCorr        whether the ratio has been
     ...
     * @return  <code>MeasuredRatioModel</code> - a new <code>MeasuredRatioModel</code>
     ...
     * @post    this <code>MeasuredRatioModel</code>'s fields are set to the
     *          values of argument <code>valueModel</code>'s respective fields
     ...
     * 
     * @pre     this <code>MeasuredRatioModel</code> exists
     * @post    returns this <code>MeasuredRatioModel</code>'s <code>fracCorr</code>
     * @return  <code>boolean</code> - <code>true</code> if this <code>
     *          MeasuredRatioModel</code> has been fractionation-corrected,
     ...
     * @post    this <code>MeasuredRatioModel</code>'s <code>fracCorr</code> is
     *          set to argument <code>fracCorr</code>
     * @param   fracCorr    should be <code>true</code> if this <code>
     *                      MeasuredRatioModel</code> has been
     *                      fractionation-corrected; else should be <code>false</code>
     */
     ...
     * 
     * @pre     this <code>MeasuredRatioModel</code> exists
     * @post    this <code>MeasuredRatioModel</code> is stored in the
    ...
    /**
     * decodes <code>MeasuredRatioModel</code> from <code>file</code>
     ...
     * @return <code>Object</code> - the <code>MeasuredRatioModel</code>
     ...
     * @post <code>MeasuredRatioModel</code> stored in <code>filename</code> is returned
     */
    @Override
    public Object readXMLObject ( String filename, boolean doValidate)
        ...
        if ( reader != null ) {
            boolean isValidOrAirplaneMode = false;
