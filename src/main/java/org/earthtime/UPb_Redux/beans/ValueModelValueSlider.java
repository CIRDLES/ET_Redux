...
public final class ValueModelValueSlider extends JPanel
        implements
        // June 2017 modified to use adapter class
        //MouseListener,
        //MouseMotionListener,
        /*Serializable,*/
        ValueModelSliderI {
...
//     
    ...
    public boolean mouseInsideValueModelSliderBox(MouseEvent evt) {
        ...
        return (evt.getX() >= valueModelSliderBox.getX())
...
//            System.out.println("PRESSED inside = " + mouseInsideValueModelSliderBox);
        }
...
//            System.out.println("DRAGGED inside = " + mouseInsideValueModelSliderBox);
            if (mouseInsideValueModelSliderBox) {
