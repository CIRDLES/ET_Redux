...
/**
 * This class abstracts the lists of models used in Redux Lab Data.
 * The design includes a first element in each list of name "<none>.
 * The second element is the first usable model.
 *
 * @param <listType> 
