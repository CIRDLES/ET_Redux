...
public class TestTopsoil {
    ...
    public TestTopsoil() {
        ...
        for (int i = 0; i < DATA.length; i++) {
            ...
            dataEntry.set(myFields.get(0), DATA[i][0]);
            dataEntry.set(myFields.get(1), DATA[i][1]);
            dataEntry.set(myFields.get(2), DATA[i][2]);
            dataEntry.set(myFields.get(3), DATA[i][3]);
            dataEntry.set(myFields.get(4), DATA[i][4]);
