/*
 * SampleImporterFromLAICPMSLegacyCVSFile_SC_WSU_vA.java
 *
 ...
 */
public class SampleImporterFromLAICPMSLegacyCVSFile_SC_WSU_vA extends AbstractSampleImporterFromLegacyCSVFile {
    ...
    public static void writeAndOpenCSVFileOfLegacyDataSampleFieldNames() {
        String fieldNames = TemplatesForCsvImport.LAICPMSLegacyDataSampleFieldNames_SC_WSU_vA;
        File CSVFile = new File("LAICPMSLegacySampleFieldNamesTemplateWSU_vA" + ".csv");
        CSVFile.delete();
