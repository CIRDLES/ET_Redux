 ...
 */
public class ProjectOfLegacySamplesImporterFromCSVFile_GA_Geochron_Delivery extends AbstractProjectImporterFromLegacyDelimitedTextFile {

    public ProjectOfLegacySamplesImporterFromCSVFile_GA_Geochron_Delivery(FileDelimiterTypesEnum fileDelimiter) {
        super(fileDelimiter);
    }
...
//                }
                ...
                if (myFractionData.get(0).startsWith("Correl") && myFractionData.get(1).startsWith("0")) {
                ...
                if (readingSamples) {
                    if (myFractionData.get(1).compareTo(savedSampleName) != 0) {
                        ...
                        try {
                            savedSampleName = myFractionData.get(1);
                            currentSample = new Sample(//
                                    myFractionData.get(1), //
                ...
                if (readingFractions) {
                    ...
                    myFraction.setFractionID(myFractionData.get(4));
                    ...
                    ratioName = "concTh";
                    myFraction.getCompositionalMeasureByName(ratioName)//
                            .setValue(readDelimitedTextCell(myFractionData.get(14)).//
                                    movePointLeft(6));
                    ...
                    myFraction.getCompositionalMeasureByName(ratioName)//
                            .setValue(readDelimitedTextCell(myFractionData.get(16)));
...
//                            .setValue(readDelimitedTextCell(myFractionData.get(index++)));
                    ratioName = "r207_206r";
                    myFraction.getRadiogenicIsotopeRatioByName(ratioName)//
                            .setValue(readDelimitedTextCell(myFractionData.get(30)));
                    ValueModel ratio = myFraction.getRadiogenicIsotopeRatioByName(ratioName);

                    // convert 2-sigma to 1-sigma
                    BigDecimal oneSigmaPct = readDelimitedTextCell(myFractionData.get(31)).//
                    ...
                    ratioName = "r207_235r";
                    myFraction.getRadiogenicIsotopeRatioByName(ratioName)//
                            .setValue(readDelimitedTextCell(myFractionData.get(32)));
                    ratio = myFraction.getRadiogenicIsotopeRatioByName(ratioName);

                    // convert 2-sigma to 1-sigma
                    oneSigmaPct = readDelimitedTextCell(myFractionData.get(33)).//
                            divide(new BigDecimal(1.0));
                    myFraction.getRadiogenicIsotopeRatioByName(ratioName)//
                            .setOneSigma(ValueModel.convertOneSigmaPctToAbsIfRequired(ratio, oneSigmaPct));
                    ...
                    ratioName = "r206_238r";
                    myFraction.getRadiogenicIsotopeRatioByName(ratioName)//
                            .setValue(readDelimitedTextCell(myFractionData.get(34)));
                    ratio = myFraction.getRadiogenicIsotopeRatioByName(ratioName);

                    // convert 2-sigma to 1-sigma
                    oneSigmaPct = readDelimitedTextCell(myFractionData.get(35)).//
                            divide(new BigDecimal(1.0));
                    myFraction.getRadiogenicIsotopeRatioByName(ratioName)//
                            .setOneSigma(ValueModel.convertOneSigmaPctToAbsIfRequired(ratio, oneSigmaPct));
                    ...
                    myFraction.getRadiogenicIsotopeRatioByName(ratioName)//
                            .setValue(readDelimitedTextCell(myFractionData.get(36)));
                    ...
                    myFraction.getRadiogenicIsotopeDateByName(ratioName)//
                            .setValue(readDelimitedTextCell(myFractionData.get(25)).//
                                    movePointRight(6));
                    myFraction.getRadiogenicIsotopeDateByName(ratioName)//
                            .setOneSigma(readDelimitedTextCell(myFractionData.get(26)).//
...
//                                    divide(new BigDecimal(2.0)).movePointRight(6));
                    ...
                    myFraction.getRadiogenicIsotopeDateByName(ratioName)//
                            .setValue(readDelimitedTextCell(myFractionData.get(23)).//
                                    movePointRight(6));
                    myFraction.getRadiogenicIsotopeDateByName(ratioName)//
                            .setOneSigma(readDelimitedTextCell(myFractionData.get(24)).//
                                    divide(new BigDecimal(1.0)).movePointRight(6));
