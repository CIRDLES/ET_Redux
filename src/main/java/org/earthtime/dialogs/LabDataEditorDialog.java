...
public class LabDataEditorDialog extends DialogEditor {
    ...
    private JTextField default206_238irmrText;
     ...
     * @throws BadLabDataException
     */
    private void editCopyOfCurrentTracerModel(boolean doAppendName)
            throws BadLabDataException {

        try {
            currentEditableTracerModel = myLabData.getATracerModel(
                    (String) tracerModelChooser.getSelectedItem()).copyModel(doAppendName);
            currentEditableTracerModel.setImmutable(false);
    ...
    private synchronized void cancelNewTracerModelEdit()
        ...
        populateTracerModelFields(myLabData.getATracerModel(
                (String) tracerModelChooser.getSelectedItem()), false);
    ...
    private synchronized void readAndRegisterTracerModel(File returnFile) {
        ...
        AbstractRatiosDataModel tempTracer = TracerUPbModel.getNoneInstance();
        ...
        boolean proceed = (tempTracer != null);
        if (proceed) {
            proceed = proceed && (tempTracer instanceof TracerUPbModel);
        }
    ...
    private void saveAndRegisterCurrentEditOfTracerModel()
            throws BadLabDataException, ETException {
        setAlwaysOnTop(false);
        tracerModelView.saveAndUpdateModelView(true);
        myLabData.registerTracer(newEmptyTracerModel, true);
        savedTracerModelName = newEmptyTracerModel.getNameAndVersion();
        initTracerModelChooser();
        tracerModelChooser.setEnabled(true);
        newEmptyTracerModel = null;
        setAlwaysOnTop(true);
...
//                myLabData.getAPhysicalConstantsModel( (String) physicalConstantsModelForInitialPbModel_Chooser.getSelectedItem() );
    ...
    private synchronized void showSavedLAICPMSLabDefaults()
        ...
        defaultInterReferenceMaterialReproducibilityLabel.setHorizontalAlignment(SwingConstants.LEFT);
        defaultInterReferenceMaterialReproducibilityLabel.setFont(ReduxConstants.sansSerif_12_Bold);
        defaultInterReferenceMaterialReproducibilityLabel.setBounds(25, 90, 450, 25);
        LAICPMSLabDefaultsPane.add(defaultInterReferenceMaterialReproducibilityLabel);

        JLabel default206_238irmrLabel = new JLabel("206 / 238 :");
        default206_238irmrLabel.setHorizontalAlignment(SwingConstants.RIGHT);
        default206_238irmrLabel.setFont(ReduxConstants.sansSerif_12_Bold);
        default206_238irmrLabel.setBounds(475, 90, 100, 25);
        LAICPMSLabDefaultsPane.add(default206_238irmrLabel);

        default206_238irmrText = new JTextField();
        default206_238irmrText.setDocument(new BigDecimalDocument(default206_238irmrText, true));
        default206_238irmrText.setHorizontalAlignment(SwingConstants.RIGHT);
        default206_238irmrText.setFont(ReduxConstants.sansSerif_12_Bold);
        default206_238irmrText.setBounds(600, 90, 75, 25);
        String text = myLabData.getDefaultInterReferenceMaterialReproducibilityMap().get(RadRatios.r206_238r).getValue().movePointRight(2).
                setScale(2, RoundingMode.HALF_UP).toPlainString();
        default206_238irmrText.setText(text);
        LAICPMSLabDefaultsPane.add(default206_238irmrText);

        JLabel default206_238irmrNote = new JLabel("% 1-sigma");
        default206_238irmrNote.setHorizontalAlignment(SwingConstants.LEFT);
        default206_238irmrNote.setFont(ReduxConstants.sansSerif_12_Bold);
        default206_238irmrNote.setBounds(700, 90, 75, 25);
        LAICPMSLabDefaultsPane.add(default206_238irmrNote);

        JLabel default206_207irmrLabel = new JLabel("206 / 207 :");
        default206_207irmrLabel.setHorizontalAlignment(SwingConstants.RIGHT);
        default206_207irmrLabel.setFont(ReduxConstants.sansSerif_12_Bold);
        default206_207irmrLabel.setBounds(475, 120, 100, 25);
        LAICPMSLabDefaultsPane.add(default206_207irmrLabel);

        default206_207irmrText = new JTextField();
        default206_207irmrText.setDocument(new BigDecimalDocument(default206_207irmrText, true));
        default206_207irmrText.setHorizontalAlignment(SwingConstants.RIGHT);
        default206_207irmrText.setFont(ReduxConstants.sansSerif_12_Bold);
        default206_207irmrText.setBounds(600, 120, 75, 25);
        text = myLabData.getDefaultInterReferenceMaterialReproducibilityMap().get(RadRatios.r206_207r).getValue().movePointRight(2).
                setScale(2, RoundingMode.HALF_UP).toPlainString();
        default206_207irmrText.setText(text);
        LAICPMSLabDefaultsPane.add(default206_207irmrText);

        JLabel default206_207irmrNote = new JLabel("% 1-sigma");
        default206_207irmrNote.setHorizontalAlignment(SwingConstants.LEFT);
        default206_207irmrNote.setFont(ReduxConstants.sansSerif_12_Bold);
        default206_207irmrNote.setBounds(700, 120, 75, 25);
        LAICPMSLabDefaultsPane.add(default206_207irmrNote);

        JLabel default208_232irmrLabel = new JLabel("208 / 232 :");
        default208_232irmrLabel.setHorizontalAlignment(SwingConstants.RIGHT);
        default208_232irmrLabel.setFont(ReduxConstants.sansSerif_12_Bold);
        default208_232irmrLabel.setBounds(475, 150, 100, 25);
        LAICPMSLabDefaultsPane.add(default208_232irmrLabel);

        default208_232irmrText = new JTextField();
        default208_232irmrText.setDocument(new BigDecimalDocument(default208_232irmrText, true));
        default208_232irmrText.setHorizontalAlignment(SwingConstants.RIGHT);
        default208_232irmrText.setFont(ReduxConstants.sansSerif_12_Bold);
        default208_232irmrText.setBounds(600, 150, 75, 25);
        text = myLabData.getDefaultInterReferenceMaterialReproducibilityMap().get(RadRatios.r208_232r).getValue().movePointRight(2).
                setScale(2, RoundingMode.HALF_UP).toPlainString();
        default208_232irmrText.setText(text);
        LAICPMSLabDefaultsPane.add(default208_232irmrText);

        JLabel default208_232irmrNote = new JLabel("% 1-sigma");
        default208_232irmrNote.setHorizontalAlignment(SwingConstants.LEFT);
        default208_232irmrNote.setFont(ReduxConstants.sansSerif_12_Bold);
    ...
    private synchronized void saveLabDefaults()
        ...
        // default LAICPMS lab data elements
        try {
        ...
        myLabData.getDefaultInterReferenceMaterialReproducibilityMap().get(RadRatios.r206_238r)//
                .setValue(new BigDecimal(default206_238irmrText.getText()).movePointLeft(2));
        myLabData.getDefaultInterReferenceMaterialReproducibilityMap().get(RadRatios.r206_207r)//
    ...
    private void initComponents() {
        ...
        tracerModelChooser = new javax.swing.JComboBox<>();
        ...
        alphaUChooser = new javax.swing.JComboBox<>();
        ...
        alphaPbChooser = new javax.swing.JComboBox<>();
        ...
        PbBlankChooser = new javax.swing.JComboBox<>();
        ...
        physicalConstantsModelForInitialPbModel_Chooser = new javax.swing.JComboBox<>();
        ...
        defaultTracer_Chooser = new javax.swing.JComboBox<>();
        defaultPbBlankIC_label = new javax.swing.JLabel();
        defaultPbBlankIC_Chooser = new javax.swing.JComboBox<>();
        defaultInitialPbModel_label = new javax.swing.JLabel();
        defaultInitialPbModel_Chooser = new javax.swing.JComboBox<>();
        ...
        defaultAlphaUModel_Chooser = new javax.swing.JComboBox<>();
        defaultAlphaPbModel_label = new javax.swing.JLabel();
        defaultAlphaPbModel_Chooser = new javax.swing.JComboBox<>();
        ...
        defaultLAICPMSPrimaryMineralStandardModel_Chooser = new javax.swing.JComboBox<>();
        ...
        saveAndRegisterCurrentEditOfTracerModel_menuItem = new javax.swing.JMenuItem();
        ...
        editCurrentLocalTracerModel_menuItem.setText("Edit Current Tracer Model (for editable models only)");
        editCurrentLocalTracerModel_menuItem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                editCurrentLocalTracerModel_menuItemActionPerformed(evt);
            }
        });
        tracers_menu.add(editCurrentLocalTracerModel_menuItem);

        editCopyOfCurrentTracer_menuItem.setText("Edit copy of current Tracer Model");
        ...
        newTracerMode_menuItem.setText("Edit new empty Tracer Model");
        ...
        cancelNewTracerEdit_menuItem.setText("Cancel Edit of Tracer Model");
        ...
        tracers_menu.add(jSeparator19);

        saveAndRegisterCurrentEditOfTracerModel_menuItem.setText("Save and Register Current Edit of Tracer Model");
        saveAndRegisterCurrentEditOfTracerModel_menuItem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                saveAndRegisterCurrentEditOfTracerModel_menuItemActionPerformed(evt);
            }
        });
        tracers_menu.add(saveAndRegisterCurrentEditOfTracerModel_menuItem);
...
// TODO add your handling code here:
    ...
    private void editCopyOfCurrentTracer_menuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editCopyOfCurrentTracer_menuItemActionPerformed
        try {
            editCopyOfCurrentTracerModel(true);
        } catch (BadLabDataException ex) {
            try {
                cancelNewTracerModelEdit();
            } catch (BadLabDataException ex2) {
                new ETWarningDialog(ex2).setVisible(true);
            }
        }
    ...
    private void tracers_menuMenuSelected(javax.swing.event.MenuEvent evt) {//GEN-FIRST:event_tracers_menuMenuSelected
        ...
        saveTracerAsXML_menuItem.setEnabled(amInEditTracerMode);
        saveAndRegisterCurrentEditOfTracerModel_menuItem.setEnabled(!amInEditTracerMode);
        ...
        try {
            ...
            editCurrentLocalTracerModel_menuItem.setEnabled(amInEditTracerMode
                    && (!selectedTracerModel.isImmutable()));
...
//        JHelpAction.showHelp(id);
    ...
    private void editCurrentLocalTracerModel_menuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editCurrentLocalTracerModel_menuItemActionPerformed
        try {
            editCopyOfCurrentTracerModel(false);
        } catch (BadLabDataException ex) {
            new ETWarningDialog(ex).setVisible(true);
        }
    }//GEN-LAST:event_editCurrentLocalTracerModel_menuItemActionPerformed

    private void saveAndRegisterCurrentEditOfTracerModel_menuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveAndRegisterCurrentEditOfTracerModel_menuItemActionPerformed
        try {
            saveAndRegisterCurrentEditOfTracerModel();
        } catch (ETException ex) {
            new ETWarningDialog(ex).setVisible(true);
        }
