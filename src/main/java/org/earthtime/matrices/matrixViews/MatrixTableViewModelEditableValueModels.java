/*
 * MatrixTableViewModelEditableValueModels.java
 *
 ...
 */
public class MatrixTableViewModelEditableValueModels extends AbstractMatrixTableViewModel {
     ...
     */
    public MatrixTableViewModelEditableValueModels(AbstractMatrixModel matrixModel, DataEntryDetectorInterface dataEntryDetector, boolean showAbsUnct) {
        super(matrixModel);
