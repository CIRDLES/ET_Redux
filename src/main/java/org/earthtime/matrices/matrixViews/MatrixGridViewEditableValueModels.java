/*
 * MatrixGridViewEditableValueModels.java
 *
 ...
 */
public class MatrixGridViewEditableValueModels extends AbstractMatrixGridView {
     ...
     */
    public MatrixGridViewEditableValueModels(AbstractMatrixModel matrixModel, DataEntryDetectorInterface dataEntryDetector, boolean showTableOnly, boolean lockDiagonal, boolean showAbsUnct) {
        super(matrixModel, true, showTableOnly);

        matrixTableViewModelEditable = new MatrixTableViewModelEditableValueModels(matrixModel, dataEntryDetector, showAbsUnct);
