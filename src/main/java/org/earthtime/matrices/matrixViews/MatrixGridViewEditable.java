 ...
 */
public class MatrixGridViewEditable extends AbstractMatrixGridView {
     ...
     */
    public MatrixGridViewEditable(AbstractMatrixModel matrixModel, DataEntryDetectorInterface dataEntryDetector, boolean showTableOnly, boolean lockDiagonal) {
        super(matrixModel, true, showTableOnly);

        matrixTableViewModelEditable = new MatrixTableViewModelEditable(matrixModel, dataEntryDetector, lockDiagonal);
