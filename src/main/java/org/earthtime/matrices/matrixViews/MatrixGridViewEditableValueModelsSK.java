/*
 * MatrixGridViewEditableValueModelsSK.java
 *
 ...
 */
public class MatrixGridViewEditableValueModelsSK extends AbstractMatrixGridView {
     ...
     */
    public MatrixGridViewEditableValueModelsSK(AbstractMatrixModel matrixModel, DataEntryDetectorInterface dataEntryDetector, boolean showTableOnly, boolean lockDiagonal, boolean showAbsUnct) {
        super(matrixModel, true, showTableOnly);

        matrixTableViewModelEditable = new MatrixTableViewModelEditableValueModelsSK(matrixModel, dataEntryDetector, showAbsUnct);
