...
public class ValueModelReferencedTest {
    ...
    */
    ...
    private void cleanFiles() throws Exception
    {
        ...
        File file = new File("test_SerializeXMLObject_Reference"); //Get the file
        if(file.exists())
        {            
            if(!(file.delete())) //delete
            {
                //throw exception in case of error
                throw new Exception("Testing File 'test_SerializeXMLObject_Referenced' couldn't be deleted");
            }
        }
        
        file = new File("test_ReadXMLObject_Referenced"); //Get the file
        if(file.exists())
        {            
            if(!(file.delete())) //delete
            {
                //throw exception in case of error
                throw new Exception("Testing File 'test_ReadXMLObject_Referenced' couldn't be deleted");
            }
        }
    } 
