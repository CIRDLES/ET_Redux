...
public class MeasuredRatioModelTest {
    ...
    */
    ...
    private void cleanFiles() throws Exception
    {
        ...
        File file = new File("test_SerializeXMLObject_MeasuredRatioModel"); //Get the file
        if(file.exists())
        {            
            if(!(file.delete())) //delete
            {
                //throw exception in case of error
                throw new Exception("Testing File 'test_SerializeXMLObject_MeasuredRatioModel' couldn't be deleted");
            }
        }
        
        file = new File("test_ReadXMLObject_MeasuredRatioModel"); //Get the file
        if(file.exists())
        {            
            if(!(file.delete())) //delete
            {
                //throw exception in case of error
                throw new Exception("Testing File 'test_ReadXMLObject_MeasuredRatioModel' couldn't be deleted");
            }
        }
    } 
